 ...
 Shiny.setInputValue("extdata", evt.data);
  ...
  ')),
                                            shinydashboard::sidebarMenu(id = "sidebar_menu",
                                              ...
                                              shinydashboard::menuItem(text = "Complex analysis", tabName = "analysis", icon = shiny::icon("chart-line")),
                                              shiny::conditionalPanel(condition = "input.sidebar_menu === 'input'",
                                                                      ...
                                                                      shiny::actionButton(inputId = "run_QC", label = "Run QC", width = "220px", icon = shiny::icon("chart-bar")),
                                              ...
                                              shiny::conditionalPanel(condition = "input.sidebar_menu === 'analysis'",
                                                                      ...
                                                                      selectizeTooltip(id = "database", choice = "CORUM", title = "CORUM version: 25.11.2022", placement = "right"),
                                                                      selectizeTooltip(id = "database", choice = "EBI Complex Portal", title = "Complex Portal version: 25.11.2022", placement = "right"),
